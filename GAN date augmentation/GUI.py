...
path1 = 'F:\\LUNA16_Dataset\\1.3.6.1.4.1.14519.5.2.1.6279.6001.100332161840553388986847034053.mhd'
# path1 = 'F:\\0-CTRespCT\\000000.dcm'
path2 = 'data\\tampered_scans\\gui'
gui = GUI(load_path=path1, save_path=path2)